                ...
                <div className=" h-full border md:border-none border-xl rounded-lg bg-white p-8"
                    ...
                    <div className="pt-12">
                        ...
                        >
                            ...
                            <button onClick={()=>navigate('/auth/login')} type="button" className="px-4 py-2 mt-4 font-mono text-md border w-full text-white bg-brown-700 hover:bg-brown-400 font-bold text-2xl rounded-xl">
                                Login Here
                            </button>
                        </div>
